...
export default function ProductLayananHome() {
      return (
            <div className="">
                  ...
                  <div className="flex flex-col sm:flex-row sm:flex-wrap gap-[48px] justify-center items-center p-6 mb-40 ">
                        ...
                        <CardProduct number="04." desc="Photography Videography memberikan visual yang estetik terhadap usahamu"
                              page="our-service-useclient/#photography-servicepage"
