            ...
            <div className='mb-40  '>
                  ...
                  <div className='flex flex-col lg:flex-row justify-center items-center m-5  lg:m-12 p-5 gap-20'>
                        <div className='w-[275px] sm:w-[550px] lg:w-[300px]' >
                              ...
                              <p className='text-[14px] sm:text-[16px] lg:text-[20px] font-[NeueMontreal] border-l-[1px] border-l-slate-800 p-2'>Menurut saya ini sangat mantap sekali, hasil yang diberikan tidak kidding-kidding sesuai dengan harapan, tidak salah mengapa orang merekomendasikan untuk selalu kesini</p>
                        </div>
                        <div className='w-[275px] sm:w-[550px] lg:w-[300px]' >
                              <FetchingServerAboutus />
                              <p className='text-[14px] sm:text-[16px] lg:text-[20px] font-[NeueMontreal] border-l-[1px] border-l-slate-800 p-2'>Menurut saya ini sangat mantap sekali, hasil yang diberikan tidak kidding-kidding sesuai dengan harapan, tidak salah mengapa orang merekomendasikan untuk selalu kesini</p>
